...
public class RailcraftLanguageProvider extends LanguageProvider {
    ...
    public RailcraftLanguageProvider(DataGenerator generator) {
        super(generator, RailcraftConstants.ID, "en_us");
    }
    ...
    this.addBlock(RailcraftBlocks.VILLAGER_DETECTOR, "Villager Cart Detector");this.addBlock(RailcraftBlocks.SWITCH_TRACK_LEVER, "Switch Track Lever");
