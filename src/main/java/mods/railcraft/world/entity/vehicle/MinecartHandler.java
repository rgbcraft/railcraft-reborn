...
public class MinecartHandler implements IMinecartCollisionHandler {
    ...
    public void onEntityCollision(AbstractMinecart cart, Entity other) {
        ...
        var sub = new Vec2((float) (other.getX() - cart.getX()), (float) (other.getZ() - cart.getZ()));
        ...
        if (depth < 0) {
            ...
            if (!isPlayer) {
                ...
                double dot = new Vec2((float) (other.getDeltaMovement().x() - cart.getDeltaMovement().x()), (float) (other.getDeltaMovement().z() - cart.getDeltaMovement().z())).dot(unit);
