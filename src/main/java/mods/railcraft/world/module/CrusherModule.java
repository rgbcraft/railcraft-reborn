...
public class CrusherModule extends CrafterModule<CrusherBlockEntity> {
    ...
    public void deserializeNBT(CompoundTag tag) {
        ...
        this.energyHandler.ifPresent(iEnergyStorage -> iEnergyStorage.receiveEnergy(tag.getInt("energyAmount"), false));
    }

    @Override
    public CompoundTag serializeNBT() {
        var tag = super.serializeNBT();
        tag.putInt("energyAmount", energyHandler.map(IEnergyStorage::getEnergyStored).orElse(0));
        return tag;
    }
