...
public class CuboidModelRenderer {
    ...
    public static void render(CuboidModel model, PoseStack matrix, VertexConsumer buffer,
        ...
        com.mojang.math.Matrix4f matrix4f = lastMatrix.pose();
        com.mojang.math.Matrix3f normalMatrix = lastMatrix.normal();
     ...
     */
    private static void putTexturedQuad(VertexConsumer buffer, com.mojang.math.Matrix4f matrix, com.mojang.math.Matrix3f normalMatrix,
    ...
    private static void drawFace(VertexConsumer buffer, com.mojang.math.Matrix4f matrix, com.mojang.math.Matrix3f normalMatrix,
