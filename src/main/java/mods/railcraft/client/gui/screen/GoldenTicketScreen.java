...
public class GoldenTicketScreen extends IngameWindowScreen {
    ...
    protected void renderContent(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        if (this.readingManual) {
            ...
            GuiUtil.drawCenteredString(poseStack, font, about, windowWidth, 15);
//            guiGraphics.drawWordWrap(this.font, help, 15, 30, 230, IngameWindowScreen.TEXT_COLOR);
            ...
            GuiUtil.drawCenteredString(poseStack, font, title, IMAGE_WIDTH / 2, 8, true);
            poseStack.popPose();
            GuiUtil.drawCenteredString(poseStack, font, desc1, windowWidth, 45);
            GuiUtil.drawCenteredString(poseStack, font, desc2, windowWidth, 60);
