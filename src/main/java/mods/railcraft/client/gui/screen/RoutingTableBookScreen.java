...
public class RoutingTableBookScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.editingTitle) {
            ...
            GuiComponent.drawString(poseStack, this.font, EDIT_TITLE_LABEL, xOffset + 160 - l,
                    yOffset + 34, 0);
            int l1 = this.font.width(formattedcharsequence);
            GuiComponent.drawString(poseStack, this.font, formattedcharsequence, xOffset + 120 - l1 / 2,
                    yOffset + 50, 0);
            int l2 = this.font.width(this.ownerText);
            GuiComponent.drawString(poseStack, this.font, this.ownerText, xOffset + 130 - l2, yOffset + 60, 0);
            ...
            GuiComponent.drawString(poseStack, this.font, manualPageIndicator, xOffset - l + 225,
                    yOffset + 15, 0);
...
//                    yOffset + 27, TEXT_WIDTH, IngameWindowScreen.TEXT_COLOR);
            ...
            GuiComponent.drawString(poseStack, this.font, this.pageMsg, xOffset - l + 225, yOffset + 15, 0);
            var displayCache = this.getDisplayCache();
            for (var lineinfo : displayCache.lines) {
                GuiComponent.drawString(poseStack, this.font, lineinfo.asComponent, lineinfo.x, lineinfo.y,
                        -16777216);
            }
    ...
    private void renderCursor(PoseStack poseStack, Pos2i cursorPos, boolean isEndOfText) {
        if (this.frameTick / 6 % 2 == 0) {
            ...
            if (!isEndOfText) {
                GuiComponent.fill(poseStack, cursorPos.x, cursorPos.y - 1, cursorPos.x + 1, cursorPos.y + 9, -16777216);
            } else {
                GuiComponent.drawString(poseStack, this.font, "_", cursorPos.x, cursorPos.y, 0);
            }
        }
    }
    ...
    private void renderHighlight(PoseStack poseStack, Rect2i[] selected) {
        for (var rect2i : selected) {
            ...
            GuiComponent.fill(poseStack, i, j, k, l, -16776961);
        }
    }
