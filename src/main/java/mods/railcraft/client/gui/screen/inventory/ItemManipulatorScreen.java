...
public class ItemManipulatorScreen extends ManipulatorScreen<ItemManipulatorMenu> {
    ...
    protected void renderLabels(@NotNull PoseStack poseStack, int mouseX, int mouseY) {
        ...
        GuiComponent.drawString(poseStack, this.font, FILTERS_TEXT, 18, 16, IngameWindowScreen.TEXT_COLOR);
        GuiComponent.drawString(poseStack, this.font, BUFFER_TEXT, 126, 16, IngameWindowScreen.TEXT_COLOR);
    }
