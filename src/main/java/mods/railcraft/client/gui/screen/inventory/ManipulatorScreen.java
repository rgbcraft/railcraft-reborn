...
public abstract class ManipulatorScreen<T extends ManipulatorMenu<?>>
    ...
    protected void renderLabels(@NotNull PoseStack poseStack, int mouseX, int mouseY) {
        GuiComponent.drawString(poseStack, this.font, this.title, this.titleLabelX, this.titleLabelY, 0x333333);
        if (this.getMenu().hasCartFilter()) {
            GuiComponent.drawString(poseStack, this.font, CART_FILTER_TEXT, 75, 16,
